    ...
    <div className="app__menuitem-details">
      <div className="app__menuitem-header">
        <div className="app__menuitem-name">
          <p className="p__cormorant" style={{ color: '#DCCA87', fontSize: '1.3rem' }}>{title}</p>
        </div>
      ...
      <div className="app__menuitem-sub">
        ...
        {description && <p className="p__opensans" style={{ color: '#C0C0C0', fontSize: '0.95rem', marginTop: '0.5rem' }}>{description}</p>}
      </div>
    </div>
  </div>
);
